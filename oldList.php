...
include "dbconnection.php";    
	...
	$sql1 = "SELECT * FROM `autonome` ORDER BY robot_name";
	$sql2 = " SELECT * FROM `racing` ORDER BY robot_name";
	$sql3 = "SELECT * FROM `somo` ORDER BY robot_name";
	$sql4 = "SELECT * FROM `terrain` ORDER BY robot_name";
    $sql5 = "SELECT COUNT(*) as nb_auto FROM autonome";
    $sql6 = "SELECT COUNT(*) as nb_rac FROM racing";
    $sql7 = "SELECT COUNT(*) as nb_somo FROM somo";
    $sql8 = "SELECT COUNT(*) as nb_terr FROM terrain";
...
?>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							<li class="active"><a href="oldList.php">Old list</a></li>
                                ...
                                <div id="wrapper" style="border-top:none;padding-top: 0.5rem;"   >
                                    ...
                                    <div class="table-wrapper">
                                        <table>
                                            ...
                                            <tbody>
                                            <tr>
                                                <td colspan=4 style="text-align: center;margin: 0;"><h2 style="margin: 0;">Autonome</h2></td>
                                            </tr> 
<?php
